...
## Project Snapshot
- Simple single-app repo: Vite + React 18 landed under `src/`, legacy pre-Vite build in `frontend/`, infra and scripts alongside.
...
- Legacy infra manifests: `deploy/` → [see deploy/AGENTS.md](deploy/AGENTS.md)
- Archived legacy frontend: `frontend/` → [see frontend/AGENTS.md](frontend/AGENTS.md)
